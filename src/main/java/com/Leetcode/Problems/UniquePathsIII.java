...
public class UniquePathsIII {
    ...
    private static int uniquePathsIII(int[][] grid) {
        ...
        getPathCount(grid, startX, startY);
        return sum;
    }

    private static void getPathCount(int[][] grid, int startX, int startY) {
        ...
        getPathCount(grid, startX + 1, startY);
        getPathCount(grid, startX, startY - 1);
        getPathCount(grid, startX - 1, startY);
        getPathCount(grid, startX, startY + 1);
