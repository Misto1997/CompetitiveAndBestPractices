...
class TrainSchedule implements Comparable<TrainSchedule> {
    ...
    TrainSchedule(int arr, int dep) {
        this.arr = arr;
        this.dep = dep;
    }

    public int compareTo(TrainSchedule s) {
        return this.dep - s.dep;
    }
}
...
public class MinimumPlatforms {
    public static void main(String[] args) {
        ...
        int dep[] = input.readIntArray(n);
        out.print(maxMeetings(arr, dep, n));
    ...
    public static int maxMeetings(int arr[], int dep[], int n) {
        ...
        while (i < n && j < n) {
            ...
            maxPlatformReq = Math.max(platformReq, maxPlatformReq);
